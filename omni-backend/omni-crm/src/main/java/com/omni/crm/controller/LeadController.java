...
public class LeadController {
    ...
    /** 分页查询线索。 */
    @GetMapping("/list") @PreAuthorize("hasAuthority('crm:lead:list')") @ServiceDataScope(permissionCode = "crm:lead:list")
    public R<PageResult<CrmViews.LeadVO>> list(@Valid CrmRequests.LeadQuery query) { return R.ok(leadService.list(query)); }

    /** 查询线索详情。 */
    @GetMapping("/{id}") @PreAuthorize("hasAuthority('crm:lead:list')") @ServiceDataScope(permissionCode = "crm:lead:list")
    public R<CrmViews.LeadVO> get(@PathVariable Long id) { return R.ok(leadService.get(id)); }

    /** 创建线索。 */
    @PostMapping @PreAuthorize("hasAuthority('crm:lead:create')") @ServiceDataScope(permissionCode = "crm:lead:create")
    ...
    /** 更新线索。 */
    @PutMapping("/{id}") @PreAuthorize("hasAuthority('crm:lead:update')") @ServiceDataScope(permissionCode = "crm:lead:update")
    ...
    /** 删除线索。 */
    @DeleteMapping("/{id}") @PreAuthorize("hasAuthority('crm:lead:delete')") @ServiceDataScope(permissionCode = "crm:lead:delete")
    ...
    /** 检查重复候选。 */
    @PostMapping("/duplicate-check") @PreAuthorize("hasAuthority('crm:lead:list')") @ServiceDataScope(permissionCode = "crm:lead:list")
    ...
    /** 分配线索负责人。 */
    @PostMapping("/{id}/assign") @PreAuthorize("hasAuthority('crm:lead:assign')") @ServiceDataScope(permissionCode = "crm:lead:assign")
    @OperLog(module = "CRM线索", operType = OperType.UPDATE, idExpr = "#id")
    ...
    /** 批量分配线索负责人。 */
    @PostMapping("/batch-assign") @PreAuthorize("hasAuthority('crm:lead:assign')") @ServiceDataScope(permissionCode = "crm:lead:assign")
    ...
    /** 标记线索合格。 */
    @PostMapping("/{id}/qualify") @PreAuthorize("hasAuthority('crm:lead:update')") @ServiceDataScope(permissionCode = "crm:lead:update")
    @OperLog(module = "CRM线索", operType = OperType.UPDATE, idExpr = "#id")
    ...
    /** 判定线索无效。 */
    @PostMapping("/{id}/disqualify") @PreAuthorize("hasAuthority('crm:lead:disqualify')") @ServiceDataScope(permissionCode = "crm:lead:disqualify")
    @OperLog(module = "CRM线索", operType = OperType.UPDATE, idExpr = "#id")
    ...
    /** 重新激活线索。 */
    @PostMapping("/{id}/reopen") @PreAuthorize("hasAuthority('crm:lead:update')") @ServiceDataScope(permissionCode = "crm:lead:update")
    @OperLog(module = "CRM线索", operType = OperType.UPDATE, idExpr = "#id")
    ...
    /** 幂等转换线索。 */
    @PostMapping("/{id}/convert") @PreAuthorize("hasAuthority('crm:lead:convert')") @ServiceDataScope(permissionCode = "crm:lead:convert")
