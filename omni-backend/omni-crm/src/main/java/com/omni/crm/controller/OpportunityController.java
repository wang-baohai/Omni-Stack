...
public class OpportunityController {
    ...
    /** 分页查询商机。 */
    @GetMapping("/list") @PreAuthorize("hasAuthority('crm:opportunity:list')") @ServiceDataScope(permissionCode = "crm:opportunity:list")
    ...
    /** 查询商机看板。 */
    @GetMapping("/board") @PreAuthorize("hasAuthority('crm:opportunity:list')") @ServiceDataScope(permissionCode = "crm:opportunity:list")
    ...
    /** 查询商机详情。 */
    @GetMapping("/{id}") @PreAuthorize("hasAuthority('crm:opportunity:list')") @ServiceDataScope(permissionCode = "crm:opportunity:list")
    ...
    /** 创建商机。 */
    @PostMapping @PreAuthorize("hasAuthority('crm:opportunity:create')") @ServiceDataScope(permissionCode = "crm:opportunity:create")
    ...
    /** 更新商机。 */
    @PutMapping("/{id}") @PreAuthorize("hasAuthority('crm:opportunity:update')") @ServiceDataScope(permissionCode = "crm:opportunity:update")
    ...
    /** 删除开放商机。 */
    @DeleteMapping("/{id}") @PreAuthorize("hasAuthority('crm:opportunity:delete')") @ServiceDataScope(permissionCode = "crm:opportunity:delete")
    ...
    @ServiceDataScope(permissionCode = "crm:opportunity:assign") @OperLog(module = "CRM商机", operType = OperType.UPDATE, idExpr = "#id")
    ...
    @ServiceDataScope(permissionCode = "crm:opportunity:stage") @OperLog(module = "CRM商机阶段", operType = OperType.UPDATE, idExpr = "#id")
    ...
    @ServiceDataScope(permissionCode = "crm:opportunity:reopen") @OperLog(module = "CRM商机阶段", operType = OperType.UPDATE, idExpr = "#id")
