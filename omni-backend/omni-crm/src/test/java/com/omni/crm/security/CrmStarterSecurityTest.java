...
/** CRM 采用公共 Starter 后的预认证与身份失败关闭回归测试。 */
class CrmStarterSecurityTest {
    ...
    void shouldRejectDirectBusinessRequest() throws Exception {
        ...
        assertThat(response.getContentAsString()).contains("CRM");
    ...
    /** 合法身份只在 CRM 请求内可见，并在 finally 中清理。 */
    @Test
