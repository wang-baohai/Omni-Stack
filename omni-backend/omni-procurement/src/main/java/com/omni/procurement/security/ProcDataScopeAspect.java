...
public class ProcDataScopeAspect {
    ...
    public Object bindScope(ProceedingJoinPoint joinPoint, ProcDataScope annotation) throws Throwable {
        ...
        try {
            ...
            ProcDataScopeContext.set(scope);
    ...
    private void validate(InternalDataScopeDTO scope, ProcTenantContext.RequestIdentity identity,
