...
/** Procurement 公共内部 API 令牌过滤器安全回归测试。 */
class InternalApiAuthFilterTest {

    private static final String TOKEN = "procurement-internal-test-token-0123456789abcdef";
    ...
    private MockHttpServletRequest request(String token) {
        MockHttpServletRequest request = new MockHttpServletRequest(
                "GET", "/api/internal/procurement/goods-receipt/asset-candidates");
        if (token != null) {
