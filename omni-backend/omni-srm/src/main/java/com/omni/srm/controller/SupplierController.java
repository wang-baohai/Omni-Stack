...
public class SupplierController {
    ...
    /** 分页查询供应商。 */
    @GetMapping("/list") @PreAuthorize("hasAuthority('srm:supplier:list')") @ServiceDataScope(permissionCode = "srm:supplier:list")
    public R<PageResult<SrmViews.SupplierVO>> list(@Valid SrmRequests.SupplierQuery query) {
        return R.ok(supplierService.list(query));
    }

    /** 查询供应商详情。 */
    @GetMapping("/{id}") @PreAuthorize("hasAuthority('srm:supplier:list')") @ServiceDataScope(permissionCode = "srm:supplier:list")
    public R<SrmViews.SupplierDetailVO> get(@PathVariable Long id) {
        return R.ok(supplierService.get(id));
    }

    /** 查询供应商 360。 */
    @GetMapping("/{id}/overview") @PreAuthorize("hasAuthority('srm:supplier:list')") @ServiceDataScope(permissionCode = "srm:supplier:list")
    public R<SrmViews.SupplierOverviewVO> overview(@PathVariable Long id) {
        return R.ok(supplierService.overview(id));
    }

    /** 创建供应商。 */
    @PostMapping @PreAuthorize("hasAuthority('srm:supplier:create')") @ServiceDataScope(permissionCode = "srm:supplier:create")
    ...
    /** 更新供应商。 */
    @PutMapping("/{id}") @PreAuthorize("hasAuthority('srm:supplier:update')") @ServiceDataScope(permissionCode = "srm:supplier:update")
    ...
    @ServiceDataScope(permissionCode = "srm:supplier:transfer")
    ...
    /** 删除供应商。 */
    @DeleteMapping("/{id}") @PreAuthorize("hasAuthority('srm:supplier:delete')") @ServiceDataScope(permissionCode = "srm:supplier:delete")
    ...
    @PostMapping("/{id}/submit") @PreAuthorize("hasAuthority('srm:supplier:create')") @ServiceDataScope(permissionCode = "srm:supplier:create")
    ...
    /** 撤回审批流程。 */
    @PostMapping("/{id}/withdraw") @PreAuthorize("hasAuthority('srm:supplier:withdraw')") @ServiceDataScope(permissionCode = "srm:supplier:withdraw")
    ...
    /** 取消审批流程。 */
    @PostMapping("/{id}/cancel") @PreAuthorize("hasAuthority('srm:supplier:cancel')") @ServiceDataScope(permissionCode = "srm:supplier:cancel")
    @OperLog(module = "SRM供应商审批", operType = OperType.UPDATE, idExpr = "#id")
    ...
    /** 冻结供应商。 */
    @PostMapping("/{id}/suspend") @PreAuthorize("hasAuthority('srm:supplier:suspend')") @ServiceDataScope(permissionCode = "srm:supplier:suspend")
    ...
    /** 恢复暂停合作的供应商。 */
    @PostMapping("/{id}/resume") @PreAuthorize("hasAuthority('srm:supplier:resume')") @ServiceDataScope(permissionCode = "srm:supplier:resume")
    ...
    @ServiceDataScope(permissionCode = "srm:supplier:restore")
    ...
    /** 加入黑名单。 */
    @PostMapping("/{id}/blacklist") @PreAuthorize("hasAuthority('srm:supplier:blacklist')") @ServiceDataScope(permissionCode = "srm:supplier:blacklist")
    @OperLog(module = "SRM供应商黑名单", operType = OperType.UPDATE, idExpr = "#id")
    ...
    /** 淘汰供应商。 */
    @PostMapping("/{id}/eliminate") @PreAuthorize("hasAuthority('srm:supplier:eliminate')") @ServiceDataScope(permissionCode = "srm:supplier:eliminate")
