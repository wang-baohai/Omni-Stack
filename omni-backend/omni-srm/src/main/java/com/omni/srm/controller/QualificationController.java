...
public class QualificationController {
    ...
    /** 查询资质列表。 */
    @GetMapping({"", "/list"}) @PreAuthorize("hasAuthority('srm:qualification:list')") @SrmDataScope(permissionCode = "srm:qualification:list")
    public R<List<SrmViews.QualificationVO>> list(@PathVariable Long supplierId) {
        return R.ok(qualificationService.list(supplierId));
    }

    /** 查询资质详情。 */
    @GetMapping("/{id}") @PreAuthorize("hasAuthority('srm:qualification:list')") @SrmDataScope(permissionCode = "srm:qualification:list")
    ...
    /** 创建资质。 */
    @PostMapping @PreAuthorize("hasAuthority('srm:qualification:create')") @SrmDataScope(permissionCode = "srm:qualification:create")
    ...
    /** 更新资质。 */
    @PutMapping("/{id}") @PreAuthorize("hasAuthority('srm:qualification:update')") @SrmDataScope(permissionCode = "srm:qualification:update")
    ...
    /** 删除资质。 */
    @DeleteMapping("/{id}") @PreAuthorize("hasAuthority('srm:qualification:delete')") @SrmDataScope(permissionCode = "srm:qualification:delete")
