...
public class SrmDataScopeAspect {
    ...
    public Object bindScope(ProceedingJoinPoint joinPoint, SrmDataScope annotation) throws Throwable {
    ...
    private void validate(InternalDataScopeDTO scope, SrmTenantContext.RequestIdentity identity,
