...
#### 図 1 `srm-overview-ja-JP`：サプライヤー概要

- 前提条件：調達またはサプライヤー管理者としてログイン
- 操作者：サプライヤー管理者
- 操作：「サプライヤー管理 → サプライヤー概要」を開く
- 期待結果：メイン領域に「サプライヤー概要」タイトルとライフサイクル分布が表示される

![サプライヤー概要](../images/ja-JP/srm-overview.png)
