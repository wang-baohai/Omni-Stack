...
# 2. Call approval-records API
pid4 = "7416dcfe-8af2-11f1-b230-d23947eb06c7"
url = f"http://localhost:8102/api/workflow/process-instance/{pid4}/approval-records"
req = urllib.request.Request(url, headers={"Authorization": f"Bearer {token}", "X-Tenant-Id": "1"})
raw_bytes = urllib.request.urlopen(req).read()

# Write raw bytes to file
with open(r"c:\WorkSpace\QODER\Omni-Stack\scripts\api-raw.json", "wb") as f:
    f.write(raw_bytes)
